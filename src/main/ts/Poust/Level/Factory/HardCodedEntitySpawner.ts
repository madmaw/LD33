            ...
            return (a: number, r: number, maxHeight: number, arc: number, difficulty: number) => {
                ...
                while (quantity > 1) {
                    ...
                    switch (amount) {
                        ...
                        case 2:
                            {
                                var flappy = new Poust.Level.Entity.FlappyEntity(GroupId.Enemy, 1, Math.random() > 0, 0.08, 0.3, r + maxHeight * Math.random() / 2);
                        ...
                        case 3:
                            {
                                var bouncer = new Poust.Level.Entity.BouncyEntity(GroupId.Enemy, 1, 0.05, Math.random() > 0.5, Math.random() > 0.5);
                        ...
                        case 4:
                            {
                                var seeker = new Poust.Level.Entity.SeekerEntity(GroupId.Enemy, 1, 200 + 30 * difficulty, 0.1, 1.1, 0.1, 0.3, 0.65);
