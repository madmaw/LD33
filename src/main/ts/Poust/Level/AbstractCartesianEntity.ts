module Poust.Level {
    ...
    export class AbstractCartesianEntity extends AbstractEntity {
        ...
        public constructor(groupId: GroupId, private _widthPx: number, private _heightPx: number, private _mass: number) {
            super(groupId);
            this._velocityDx = 0;
            this._velocityDy = 0;
        }
        ...
        calculateMotion(timeMillis: number): IMotion {
            ...
            return new Poust.Level.Motion.CartesianMotion(cx, cy, newBounds, this);
        }
